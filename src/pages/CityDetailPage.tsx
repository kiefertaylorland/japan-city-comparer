        ...
        <div className="absolute inset-0 flex items-center">
          <div className="container-custom">
            <div className="max-w-2xl text-white space-y-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white drop-shadow-2xl" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8), 0 0 8px rgba(0,0,0,0.6)'}}>
                {city.displayName}
              </h1>
            ...
            <div className="flex gap-2">
              {['tokyo', 'osaka', 'kyoto'].filter(id => id !== city.id).map((otherCityId) => (
                <Link
                  key={otherCityId}
                  to={`/city/${otherCityId}`}
                  className="border-2 border-white bg-transparent text-white px-6 py-3 rounded-lg font-medium hover:bg-white hover:text-charcoal-gray transition-colors duration-200 focus:ring-2 focus:ring-white focus:ring-offset-2"
                >
